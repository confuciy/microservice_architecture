...
class DeliveryController
{
    ...
    public function create(array $data = [])
    {
        try {
            ...
            if ($jwt_token_data['user_id'] != $data['user_id']) {
...
//            }
            ...
            $delivery = $this->delivery->getDeliveryOrder($jwt_token_data['user_id'], $data['order_id']);
    ...
    public function delivered(array $data = [])
    {
        try {
            ...
            $delivery = $this->delivery->getDeliveryOrder($userId, $data['order_id']);

            if (isset($delivery['action']) and $delivery['action'] == 'create') {
