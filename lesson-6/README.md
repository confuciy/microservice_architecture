...
##### Схема взаимодействия сервисов на примере логина и просмотра профила пользователя
![interaction_of_services.drawio.png](./img/interaction_of_services.drawio.png)
