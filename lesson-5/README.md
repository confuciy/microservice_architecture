...
По Postgresql:
1. Блокировки, конфликты;
2. Обращений в секунду;
3. Средние показатели по операциям;

![grafana_4.png](./img/grafana_4.png)


#### Alerting - Alert Rules:

1. Настроен алерт на получение 500-х более чем 3% от общего числа запросов.
После превышения мониторинг 1 минуту до отправки алерта (почтой Grafana, не настроено).
- На графике API Error Rate (%) видно срабатывание алертов.

2. Настроен алерт на время выполнение запросы более 2-х секунд.
После превышения мониторинг 1 минуту до отправки алерта (почтой Grafana, не настроено).
